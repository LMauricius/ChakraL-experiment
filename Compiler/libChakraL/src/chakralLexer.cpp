...
namespace ChakraL
{
    const std::array<std::string, 95> TokenNames {
        "L_IF",
        "L_ELSE",
        "L_ELIF",
        "L_SWITCH",
    ...
    const std::array<std::wstring, 95> WTokenNames {
        L"L_IF",
        L"L_ELSE",
        L"L_ELIF",
        L"L_SWITCH",
        ...
        L"L_MOD_CHANGE",
        L"L_EXP_CHANGE",
        L"L_SHIFT_RIGHT_CHANGE",
        L"L_SHIFT_LEFT_CHANGE",
        L"L_AND_CHANGE",
        L"L_OR_CHANGE",
        L"L_XOR_CHANGE",
        L"L_CROSS_CHANGE",
...
(maxEnd-start)
                ...
                case 49:// %
                    ...
                    break;
                case 50:// \^
                    ret.push_back(Token{TokenType::L_EXP, input.substr(start, maxEnd-start), line, character});
                    break;
                case 51:// >>
                ...
                case 67:// %[=]
                    ...
                    break;
                case 68:// \^[=]
                    ret.push_back(Token{TokenType::L_EXP_CHANGE, input.substr(start, maxEnd-start), line, character});
                    break;
                case 69:// >>[=]
